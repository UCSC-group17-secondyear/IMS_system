    ...
    elseif (isset($_POST['semPdf'])) {
        ...
        class getPdf extends FPDF
        {
            ...
            function displayInfo($connect) {
                ...
                $this -> Cell(50, 10, "Index Number", 1, 0, 'C');
                $this -> Cell(100, 10, "Subject Name", 1, 0, 'C');
                $this -> Cell(50, 10, "Session Type", 1, 0, 'C');
                ...
                while ($record = mysqli_fetch_assoc($attendance)) {
                    ...
                    $this -> Cell(50, 10, $result_student_index['index_no'], 1, 0);
                    $this -> Cell(100, 10, $result_subject_name['subject_name'], 1, 0);
                    $this -> Cell(50, 10, $result_sessionType['sessionType'], 1, 0);
