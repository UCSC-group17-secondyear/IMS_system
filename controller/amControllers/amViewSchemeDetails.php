<?php
    ...
    require_once('../../model/amModel/viewSchemesModel.php');

    $_SESSION['scheme_list'] = '';

    $records = amModel::viewSchemes($connect);
    ...
    if ($records) {
        while ($record = mysqli_fetch_assoc($records)) {
            ...
            header('Location:../../view/attendanceMaintainer/amSchemDetailsV.php');
        }
    }
    else {
        header('Location:../../view/attendanceMaintainer/amNoSchemesV.php');
    }
