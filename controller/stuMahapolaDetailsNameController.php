...
<?php
    ...
    $student_initials = mysqli_real_escape_string($connect, $_GET['student_intials']);
    $student_surname = mysqli_real_escape_string($connect, $_GET['student_surname']);

    $result_set = Model::getStuDetailsName($student_initials,$student_surname,$connect);
