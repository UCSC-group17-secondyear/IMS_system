<?php
    ...
    require_once('../../model/dhModel/viewSchemesModel.php');

    $_SESSION['scheme_list'] = '';

    $records = dhModel::viewSchemes($connect);
    ...
    if ($records) {
        while ($record = mysqli_fetch_assoc($records)) {
            ...
            header('Location:../../view/departmentHead/dhMedicalSchemDetailsV.php');
        }
    }
    else {
        header('Location:../../departmentHead/dhNoSchemsV.php');
    }
