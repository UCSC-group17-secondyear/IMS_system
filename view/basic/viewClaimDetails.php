<main>
    <form>
        ...
        <div class="collapse">
            <p>Could apply immediately with the appointment for individual scheme and Family coverage only after one
                year of service period</p>
        </div>

        <button type="button" class="collapsible">Contract staff</button>
        <div class="collapse">
            <p>Could apply for individual scheme after six months of service and family coverage after two years of
                service period </p>
        </div>

        <button type="button" class="collapsible">Assignment/Temporary staff</button>
        <div class="collapse">
            <p>Could apply for individual scheme after one year of service period and not eligible for the family
                coverage (⃰Exception: the temporary staff those who had already obtained both individual and family
                coverage of scheme could re-apply for both)</p>
        </div>
    </form>
