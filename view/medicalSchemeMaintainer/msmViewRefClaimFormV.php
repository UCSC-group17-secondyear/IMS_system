...
<main>
    ...
    <div class="sansserif">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li><a href="../../controller/msmControllers/refferedFormController.php">Reffered Form List</a></li>
                ...
                <div class="contentForm" style="margin-bottom: 1%;">
                    ...
                    ?>
                        <button class="subbtn" type="submit" name="">
                            <a href="../../controller/msmControllers/refferedFormController.php">View Another</a>
                        </button>
