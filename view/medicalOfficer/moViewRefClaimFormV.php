    ...
    <div class="sansserif">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li><a
                            ...
                            ?>
                                href="../../controller/moControllers/refferedClaimFormListController.php?btn=71"
                            <?php
                                }
                            ?>
                            ...
                            ?>
                                href="../../controller/moControllers/refferedClaimFormListController.php?btn=72"
                            <?php
                                }
                            ?>
                    >Form List</a></li>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            ?>
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <input type="text" name="revised_amount" <?php echo 'value="'.$_SESSION['revised_amount'].'"'?> readonly> <br>
                                    </div>
                                </div>
                            <?php
                                }
