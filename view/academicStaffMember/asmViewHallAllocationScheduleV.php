        ...
        <div class="row">
            ...
            <div class="col right80">
                ...
                <div class="contentForm">
                    <form action="../../controller/asmControllers/asmViewHallAllocScheduleC.php?asmuser=<?php echo $_SESSION['userId'] ?>" method="post">
                        <div class="row">
                            <div class="col-25">
                        ...
                        <button class="cancelbtn" type="submit"><a href="asmHomeV.php">Cancel</a></button>
                    </form>
                    <form action="../../controller/asmControllers/asmViewHallAllocScheduleC.php?asmuser=<?php echo $_SESSION['userId'] ?>" method="post">
                        <div class="row">
                            <div class="col-25">
