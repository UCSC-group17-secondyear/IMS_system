...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="lAddBookingV.php"><button type="submit" name="">Add a Booking</button></a><br><br>
            <a href="lUpdateBookingV.php"><button type="submit" name="">Update/ Remove Booking</button></a>
