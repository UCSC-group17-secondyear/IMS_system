...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="lEnterTimeTableV.php"><button type="submit" name="">Enter Time Table</button></a>
            <br>
            <br>
            <a href="lUpdateTimeTableV.php"><button type="submit" name="">Update/Remove Time Table</button></a>
