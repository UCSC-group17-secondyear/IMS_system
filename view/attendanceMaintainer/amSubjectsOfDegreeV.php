...
<main>
    <div class="sansserif">
        <ul class="breadcrumbs">
            ...
            <li><a href="amSelectDegreeV.php">Select a Degree</a></li>
        ...
        <div class="row" style="margin-bottom: 4%;" >
            ...
            <div class="col right80">
                <div>
                    <h2>Subjects List of the selected degree</h2>
                </div>
                ...
                <div class="contentForm">
                    <form action="" method="post">
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" name="degree_name" disabled <?php echo 'value=" '.$_SESSION['degree_name'].'"' ?> >
                            </div>
                        </div>
