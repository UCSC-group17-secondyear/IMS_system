...
<main>
    ...
    <div class="sansserif">
        <ul class="breadcrumbs">
            ...
            <li><a href="amGetBatchV.php">Get Batch</a></li>
            <li class="active">Batch-wise Students' Details</li>
        </ul>
        ...
        <div class="row" style="margin-bottom: 4%;" >
            ...
            <div class="col right80">
                <div>
                    <h2>Batch-wiae Students' Details</h2>
                </div>
                ...
                <div class="contentForm">
                    <form action="" method="post">
                        <div class="row">
                            <div class="col-25">
                                <label for="">Selected Batch</label>
                            </div>
                            <div class="col-75">
                                <input type="text" name="batch_number" disabled <?php echo 'value=" '.$_SESSION['batch_number'].'"' ?> >
                            </div>
                        </div>
