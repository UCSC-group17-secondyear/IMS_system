...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="aAddSemesterV.php"><button type="submit" name="">Add a new Semester</button></a><br><br>
            <a href="aUpdateRemoveSemesterV.php"><button type="submit" name="">Update or remove a Semester</button></a>
        </div>
        <div class="footer">
            <?php
