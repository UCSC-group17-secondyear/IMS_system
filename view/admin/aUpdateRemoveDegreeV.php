...
<body>
    <div class="container">
        ...
        <div class="content">
            <div>
                <h3>Update/Remove Degree</h3>
            </div>
            <div class="formStyle">
                <form action="aUpdateRemoveDegree.php" method="post">
                    Degree Name: <input type="text" name="degree" placeholder="Enter degree name" required><br>
                    Description: <input type="text" name="description" placeholder="Degree description" required><br>
