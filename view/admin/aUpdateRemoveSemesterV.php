...
<body>
    <div class="container">
        ...
        <div class="content">
            <div>
                <h3>Update/Remove Semester</h3>
            </div>
            <div class="formStyle">
                <form action="aAddSemester.php" method="post">
                    Semester: <input type="text" name="semester" placeholder="Enter Semester" required><br>
                    Starting Date: <input type="text" name="startDate" placeholder="Enter starting date" required><br>
                    Ending Date: <input type="text" name="endDate" placeholder="Enter ending date" required><br>
