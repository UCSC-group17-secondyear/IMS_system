...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="aAddDesignationV.php"><button type="submit" name="">Add a new Designation</button></a><br><br>
            <a href="aUpdateRemoveDesignationV.php"><button type="submit" name="">Update or remove a Designation</button></a>
        </div>
        <div class="footer">
            <?php
