        ...
        <div class="content">
            ...
            <div class="formStyle">
                <form action="aAddDepartment.php" method="post">
                    Department Name : <input type="text" name="departmentName" placeholder="Enter department name" required><br>
                    Description: <input type="text" name="departmentDescriotion" placeholder="Enter its description" required><br>
