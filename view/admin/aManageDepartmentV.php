...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="aAddDepartmentV.php"><button type="submit" name="">Add a new Department</button></a><br><br>
            <a href="aUpdateRemoveDepartmentV.php"><button type="submit" name="">Update or remove a Department</button></a>
        </div>
        <div class="footer">
            <?php
