...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="aAddSessionV.php"><button type="submit" name="">Add a new Session</button></a><br><br>
            <a href="aUpdateRemoveSessionV.php"><button type="submit" name="">Update or remove a Session</button></a>
        </div>
        <div class="footer">
            <?php
