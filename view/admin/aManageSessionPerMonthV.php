...
<body>
    <div class="container">
        ...
        <div class="content">
            <div>
                <h3>Manage Sessions Per Month</h3>
            </div>
            <a href="aAddSessionPerMonthV.php"><button type="submit" name="">Add a new Session Per Month</button></a><br><br>
            <a href="aUpdateRemoveSessionPerMonthV.php"><button type="submit" name="">Update or remove a Sessions Per Month</button></a><br><br>
        </div>
        <div class="footer">
            <?php
