...
<body>
    <div class="container">
        ...
        <div class="content">
            <div>
                <h3>Add Sessions Per Month</h3>
            </div>

            <div class="formStyle">
                <form action="aUpdateRemoveSessionPerMonth.php" method="post">
                    Month: <input type="text" name="month" placeholder="Enter month" required><br>
                    ...
                    Number of Sessions per month: <input type="text" name="numOfSessions"
                        placeholder="Enter number of sessions per month" required><br>
