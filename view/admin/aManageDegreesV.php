...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="aAddDegreeV.php"><button type="submit" name="">Add a new degree</button></a><br><br>
            <a href="aUpdateRemoveDegreeV.php"><button type="submit" name="">Update or remove a degree</button></a>
        </div>
        <div class="footer">
            <?php
