...
<main>
    ...
    <div class="sansserif">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li><a href="../../controller/rvControllers/requestedFormController.php">Requested Form List</a></li>
                ...
                <div class="contentForm" style="margin-bottom: 1%;">
                    ...
                    ?>
                        <button class="subbtn" type="submit" name="">
                            <a href="../../controller/rvControllers/requestedFormController.php">View Another</a>
                        </button>
