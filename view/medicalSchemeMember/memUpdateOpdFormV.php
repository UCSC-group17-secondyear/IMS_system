                    ...
                    <div class="col right80">
                        ...
                        <div class="contentForm" style="margin-bottom: 1%;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input type="date" <?php echo 'max="'.$_SESSION['max_date'].'"' ?> name="treatment_received_date" <?php echo 'value="'.$_SESSION['treatment_received_date'].'"'?> id="tdate" required> <br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input type="date" <?php echo 'max="'.$_SESSION['max_date'].'"' ?> name="bill_issued_date" <?php echo 'value="'.$_SESSION['bill_issued_date'].'"'?> id="bdate" oninput="checkDate()"; required> <br>
                                </div>
                            </div>
