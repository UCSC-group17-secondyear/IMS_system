<?php
	class basicModel {
		...
		{
			$query = "UPDATE tbl_user_flag SET department='{$department}', healthcondition='{$health_condition}', civilstatus='{$civil_status}', member_type='{$member_type}', schemename='{$scheme}', membership_status=2, form_submission_date=CURRENT_DATE() WHERE user_id={$user_id}";
