<?php
    class claimFormModel {
        ...
        public static function paidClaimForms($connect){
            $query = "SELECT * FROM tbl_claimform WHERE acceptance_status='1' AND paid_status='1'";
        ...
        public static function getRejClaimForms($connect){
            $query = "SELECT * FROM tbl_claimform WHERE acceptance_status='0' OR paid_status='0'";
        ...
        public static function getDependPatientName($user_id,$dependant_id,$connect){
			$query = "SELECT dependant_name FROM tbl_dependant WHERE dependant_id={$dependant_id} AND user_id={$user_id} LIMIT 1";
