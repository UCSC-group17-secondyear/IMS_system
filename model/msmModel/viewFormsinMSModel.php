<?php
    class msmModel{
		...
		{
            $query = "SELECT u.*, cf.*, d.* FROM tbl_claimform cf, users u, tbl_dependant d WHERE d.dependant_id = cf.dependant_id AND cf.user_id = u.userId AND acceptance_status='1' AND paid_status='2' ORDER BY submitted_date DESC";
